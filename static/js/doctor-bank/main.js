define([ 'template/doctor.tpl'], function(doctorTpl){
    ...
    function getData(){
        var opts = {
            params:{},
            cgi: "/controller/doctorAction/queryListBySearch.do",
            successCall: function(res){
                if(res.ret==0){
                    ...
                    if(isInIted){
                        $('#doctor-list').append(doctorTpl(res.data, param));
                    }else{
                        $('#doctor-list').html(doctorTpl(res.data, param));
                    }
